...
export function Invoice({ userData }: InvoiceProps) {
  ...
  const form = useForm<InvoiceData>({
    defaultValues: {
      ...
      rowEntries: [{ description: "", account: "", quantity: 1, price: 0, taxRate: "" as any }],
    ...
    if (missingFields.length > 0) {
      alert(
        `Cannot generate QR code. The following required fields are missing:\n\n` +
          ...
          (missingFields.includes("Company Name") || missingFields.includes("Tax Registration Number")
  ...
  const onSubmit = async (data: InvoiceData) => {
    // Validate QR code is generated
    if (!qrCodeDataURL) {
      alert(
        "⚠️ Generating QR code is mandatory!\n\n" +
        "Please click the 'Generate QR Code' button before saving the invoice.\n\n" +
        "The QR code is required for ZATCA compliance."
      );
      return;
    }
        ...
        <div className="flex justify-between items-start mt-8">
          ...
          <div className="flex flex-col gap-4">
            {qrCodeDataURL ? (
              ...
              <div className="flex flex-col gap-4">
                <div className="border border-gray-200 rounded-lg p-4 bg-gray-50 w-[232px]">
